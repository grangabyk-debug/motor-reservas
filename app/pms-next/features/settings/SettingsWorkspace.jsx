...
export default function SettingsWorkspace({propertyId,property}){
  ...
  async function savePrefs(nextPrefs){setSaving("prefs");setError("");setNotice("");try{await persistSettings({...settings,preferences:nextPrefs},"Preferencias guardadas.")}catch(err){setError(err?.message||"No se pudieron guardar las preferencias.")}finally{setSaving("")}}
