...
const polish=`[data-subscription] section[class*="paymentMethod"] button{display:none!important}[data-subscription] button svg,[data-subscription] li svg,[data-subscription] footer b svg{vertical-align:middle;flex:0 0 auto}[data-subscription] li,[data-subscription] footer b,[data-subscription] button{gap:7px}[data-subscription]>div>section:first-of-type>button{color:#26347a!important;-webkit-text-fill-color:#26347a!important}`
