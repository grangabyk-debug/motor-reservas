...
export const ARRIVAL_COLUMNS=[
  {key:"reservation",label:"Reserva"},{key:"channel",label:"Canal"},{key:"guest",label:"Huésped"},{key:"room",label:"Habitación"},{key:"pax",label:"Pax"},{key:"note",label:"Notas"},{key:"time",label:"Hora"},{key:"total",label:"Total estadía"},{key:"paid",label:"Abonado"},{key:"balance",label:"Saldo",required:true},
  {key:"currency",label:"Moneda",defaultVisible:false},{key:"phone",label:"Teléfono",defaultVisible:false},{key:"status",label:"Estado",defaultVisible:false},{key:"regime",label:"Régimen",defaultVisible:false},{key:"arrival",label:"Llegada",defaultVisible:false},{key:"departure",label:"Salida",defaultVisible:false},
]
