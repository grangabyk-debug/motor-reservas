...
const premiumPolish=`
[data-maintenance-premium]{font-size:15px;color:var(--text,#172033)}
...
[data-maintenance-premium] nav button{font-size:13px!important;font-weight:850!important}
...
[data-maintenance-premium] label[style] input{width:min(360px,38vw);height:42px;border:1px solid var(--lineStrong,#dfe5ed);border-radius:12px;background:var(--panelSolid,#fff);color:var(--text,#172033);outline:none}
