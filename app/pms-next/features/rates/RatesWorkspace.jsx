...
import changeRatePlanCurrency from"./changeRatePlanCurrency"
...
export default function RatesWorkspace({propertyId,property}){
  ...
  async function switchCurrency(target){return changeRatePlanCurrency({propertyId,target,isOwner,pricing,effectiveFx,fx,propertySettings,setPropertySettings,load,setSaving,setError})}
