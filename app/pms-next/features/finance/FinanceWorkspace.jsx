...
export default function FinanceWorkspace({propertyId,property,onNavigate,focusReservationId,onFocusHandled}){
  ...
  return <section className={s.page}>
    ...
    {tab==="cash"?<DailyCashWorkspace embedded propertyId={propertyId} property={property} onNavigate={onNavigate} focusReservationId={focusReservationId} onFocusHandled={onFocusHandled}/>:tab==="dashboard"?<FinanceDashboard propertyId={propertyId}/>:tab==="payments"?<PaymentsPanel propertyId={propertyId}/>:tab==="automation"&&automationAllowed!==false?<PaymentAutomationPanel propertyId={propertyId}/>:tab==="online"?<OnlinePaymentsPanel propertyId={propertyId}/>:tab==="documents"?<DocumentsPanel propertyId={propertyId}/>:tab==="fiscal"?<FiscalLatamPanel propertyId={propertyId}/>:<ExpensesPanel propertyId={propertyId}/>} 
  </section>
}
