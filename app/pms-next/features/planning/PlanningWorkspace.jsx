...
export default function PlanningWorkspace({propertyId,property,onNavigate}){
  ...
  const visibleRooms=useMemo(()=>{
    ...
    return data.rooms.filter(room=>(typeFilter==="all"||(room.tipo||"Sin tipo")===typeFilter)&&(!term||`${room.nombre} ${room.tipo||""}`.toLowerCase().includes(term)))
