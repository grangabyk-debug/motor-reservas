...
export function ReservationBlock({item,days,selected,onSelect,onDragStart,onResizeStart,settings,onPreview}){
  ...
  const stayLabel=(noShow?`${item.nombre_huesped}, No Show, estadía original ${item.fecha_entrada} a ${item.fecha_salida}`:dayUse?`${item.nombre_huesped}, ${pax} pasajeros, ${channel.label}, ${stageLabel}, ${payment.label}, day use`:group?`${item.nombre_huesped}, ${pax} pasajeros en esta habitación, ${channel.label}, ${stageLabel}, ${payment.label}, grupo de ${rooms} habitaciones, ${nights} noches${early?", Early check-in":""}${late?", Late check-out":""}`:`${item.nombre_huesped}, ${pax} pasajeros, ${channel.label}, ${stageLabel}, ${payment.label}, ${nights} noches`)+lockLabel
