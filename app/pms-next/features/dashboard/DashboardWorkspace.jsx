...
export default function DashboardWorkspace({propertyId,property,onNavigate,allowedViews=[]}){
  ...
  const[opsDay,setOpsDay]=useState(0),[opsQuery,setOpsQuery]=useState(""),[widgetOrder,setWidgetOrder]=useState(DEFAULT_WIDGETS),[dragging,setDragging]=useState(""),[oliviaHidden,setOliviaHidden]=useState(false)
