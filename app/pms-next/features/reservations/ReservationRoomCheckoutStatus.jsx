...
export function RoomCheckoutHeroBadge({count,total,finalized=false}){
  ...
  return <span style={{padding:"5px 9px",border:"1px solid color-mix(in srgb,#7656c9 34%,var(--line))",borderRadius:999,background:"color-mix(in srgb,#7656c9 10%,var(--panelSolid))",color:"#5e43aa",fontSize:10.5,fontWeight:900}}>✓ {count} de {total} hab. con check-out</span>
}
export function RoomCheckoutFact({count}){return count?<span style={{display:"block",marginTop:2,fontSize:10,color:"#5e43aa",fontWeight:850}}>✓ {count} con check-out</span>:null}
