...
export default function useReservationsData(propertyId){
  ...
  return{reservations,rooms,payments,paymentByReservation,loading,loadingMore,hasMore,error,setError,load,loadMore,updateReservation,previewMove,addRoomToReservation,mergeReservations,moveReservation,checkin,checkout,markNoShow,restoreNoShow,restoreCancelledReservation,cancelReservation}
}