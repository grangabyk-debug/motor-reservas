...
export const HOUSEKEEPING_NAV=[
  {id:"housekeeping",label:"Estado de habitaciones",icon:"clean"},
...
export const NAV_LABELS=[...PRIMARY_NAV,...RECEPTION_NAV,...HOUSEKEEPING_NAV,...OPERATIONS_NAV,...MANAGEMENT_NAV].reduce((acc,item)=>{acc[item.id]=item.label;return acc},{})
export const VIEW_DESCRIPTIONS={
  dashboard:"Resumen operativo del hotel: llegadas, huéspedes alojados, salidas, ocupación, habitaciones y alertas que requieren atención.",planning:"Calendario operativo para crear, mover, extender y revisar reservas y disponibilidad por habitación.",reservations:"Listado y ficha completa de cada reserva, con huéspedes, estadía, pagos, documentos, historial y acciones de recepción.",quotes:"Creá y seguí presupuestos antes de convertirlos en reservas, con fechas, habitaciones, tarifas y condiciones.",guests:"Historial y perfil de huéspedes para reconocer repetidores, preferencias, idioma, etiquetas y datos de contacto.",messages:"Centraliza comunicaciones vinculadas a huéspedes y reservas para que el seguimiento quede asociado a la operación.",dailycash:"Caja operativa de recepción por día: cobros de reservas, efectivo, transferencias, tarjetas, movimientos, comprobantes y arqueo.",finance:"Cobros, saldos, documentos, solicitudes de pago y movimientos financieros vinculados a las reservas.",receptionreports:"Planillas operativas de recepción para llegadas, salidas, desayuno y housekeeping, listas para descargar o imprimir.",housekeeping:"Estado de limpieza e inspección de habitaciones, asignación de tareas y preparación para próximas llegadas.",tasks:"Check-lists de Housekeeping y rutinas de control de habitaciones.",requests:"Solicitudes de huéspedes vinculadas a reserva, habitación, prioridad, responsable, vencimiento y estado.",maintenance:"Incidencias técnicas del hotel con prioridad, habitación, responsable, vencimiento y seguimiento hasta resolución.",inventory:"Stock operativo, movimientos y niveles de reposición de insumos utilizados por el hotel.",services:"Catálogo y cargos de servicios y extras que pueden agregarse a reservas y cuentas de huéspedes.",rates:"Tarifas, disponibilidad y restricciones comerciales por fecha para controlar lo que se vende.",onboarding:"Checklist de implementación para saber qué falta antes de operar y vender con una propiedad.",website:"Editor simple de la web del hotel: plantilla, portada, galería, presentación, contacto y SEO, siempre conectado al mismo motor de reservas.",growth:"Indicadores y herramientas comerciales para entender origen de reservas, producción y oportunidades de venta.",revenue:"Forecast, pickup, ADR, RevPAR y recomendaciones de revenue construidas con reservas reales, sin cambios automáticos de tarifa.",reports:"Informes operativos, comerciales y financieros construidos con los datos reales de la propiedad.",audit:"Trazabilidad de cambios y acciones realizadas en el PMS para saber qué pasó, cuándo y sobre qué registro.",staff:"Usuarios, roles, permisos y procedimientos operativos de la propiedad.",integrations:"Canales de venta, motor web y conexiones externas de la propiedad, con estado y herramientas de implementación.",settings:"Configuración de la propiedad, preferencias operativas, branding, reglas y funciones habilitadas.",support:"Primero te ayuda el asistente de Habitación Llena; si no alcanza, podés escalar la conversación completa al equipo de soporte."
}
export const ALL_VIEWS=Object.keys(NAV_LABELS)
export const ROLE_VIEWS={owner:ALL_VIEWS,manager:ALL_VIEWS,admin:ALL_VIEWS,reception:["dashboard","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","housekeeping","tasks","requests","maintenance","inventory","services","rates","audit","support"],night_audit:["dashboard","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","housekeeping","tasks","requests","maintenance","inventory","services","rates","reports","audit","support"],housekeeping:["dashboard","planning","housekeeping","tasks","requests","maintenance","inventory","support"],maintenance:["dashboard","planning","tasks","requests","housekeeping","maintenance","inventory","support"],revenue:["dashboard","planning","reservations","quotes","guests","services","dailycash","rates","finance","website","growth","revenue","reports","support"],member:["dashboard","support"]}
