...
export const ROLE_VIEWS={
  ...
  reception:["dashboard","tasks","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","inventory","services","rates","audit","help","support"],
  night_audit:["dashboard","tasks","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","inventory","services","rates","reports","audit","help","support"],
