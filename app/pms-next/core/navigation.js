...
export const VIEW_MODULES={
  ...
  onboarding:"core_pms",website:"website_booking",growth:"guest_crm",revenue:"revenue",channelmanager:"channel_manager",
  ...
  tasks:"core_pms",requests:"core_pms",subscription:"core_pms"
}

export const ALL_VIEWS=Object.keys(NAV_LABELS)
export const ROLE_VIEWS={
  owner:ALL_VIEWS,manager:ALL_VIEWS,admin:ALL_VIEWS,
  reception:["dashboard","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","inventory","services","rates","audit","support"],
  night_audit:["dashboard","planning","reservations","quotes","guests","messages","dailycash","finance","receptionreports","inventory","services","rates","reports","audit","support"],
  housekeeping:["dashboard","housekeeping","inventory","support"],
  maintenance:["dashboard","maintenance","inventory","support"],
  revenue:["dashboard","planning","reservations","quotes","guests","services","dailycash","rates","finance","website","growth","revenue","channelmanager","reports","support"],
