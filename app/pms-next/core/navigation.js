...
export const ROLE_VIEWS={
  ...
  revenue:["dashboard","planning","reservations","quotes","guests","services","dailycash","rates","finance","website","growth","revenue","intelligence","channelmanager","reports","support"],
