...
export const DISTRIBUTION_NAV=[
  {id:"channelmanager",label:"Canales y sincronización",icon:"link"},
  {id:"website",label:"Venta directa · Web y motor",icon:"link"},
]
...
export const VIEW_MODULES={
  dashboard:"core_pms",portfolio:"core_pms",tasks:"core_pms",planning:"core_pms",reservations:"core_pms",quotes:"core_pms",guests:"core_pms",crm:"guest_crm",messages:"core_pms",
...
export const ROLE_VIEWS={
  ...
  reception:["dashboard","tasks","planning","reservations","quotes","guests","crm","messages","dailycash","dailycontrol","finance","receptionreports","inventory","services","rates","audit","help","support"],
  night_audit:["dashboard","tasks","planning","reservations","quotes","guests","crm","messages","dailycash","dailycontrol","finance","receptionreports","inventory","services","rates","reports","audit","help","support"],
  ...
  revenue:["dashboard","portfolio","tasks","planning","reservations","quotes","guests","crm","services","dailycash","rates","finance","website","growth","revenue","intelligence","channelmanager","reports","help","support"],
