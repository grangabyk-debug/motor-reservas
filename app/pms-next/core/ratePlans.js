export const RATE_PLAN_PRESETS=[
  {code:"BB",name:"Alojamiento + desayuno",meal_plan:"breakfast",legacy_regimen:"Desayuno incluido",description:"Alojamiento con desayuno incluido en la tarifa.",adjustment_basis:"per_room"},
  {code:"RO",name:"Solo alojamiento",meal_plan:"room_only",legacy_regimen:"Solo alojamiento",description:"Alojamiento sin comidas incluidas.",adjustment_basis:"per_room"},
  {code:"HB",name:"Media pensión",meal_plan:"half_board",legacy_regimen:"Media pensión",description:"Alojamiento con desayuno y una comida principal.",adjustment_basis:"per_person"},
  {code:"FB",name:"Pensión completa",meal_plan:"full_board",legacy_regimen:"Pensión completa",description:"Alojamiento con desayuno, almuerzo y cena.",adjustment_basis:"per_person"},
  {code:"AI",name:"Todo incluido",meal_plan:"all_inclusive",legacy_regimen:"Todo incluido",description:"Alojamiento con el régimen todo incluido.",adjustment_basis:"per_person"},
]
