...
export const DASHBOARD_PRESETS={
  reception:{
    ...
    order:["turn-pulse","priorities","arrivals","inhouse","departures","occupancy","kpi-occupancy","kpi-reservations","kpi-production","kpi-housekeeping","cleaning","channels","reservation-metrics"],
    hidden:[],
    sizes:{"turn-pulse":"2x1","priorities":"2x1","arrivals":"2x1","inhouse":"2x1","departures":"2x1","occupancy":"2x2"},
  },
  management:{
    label:"Dirección",
    description:"Ocupación, producción y canales sin ruido operativo.",
    order:["occupancy","kpi-occupancy","kpi-production","kpi-reservations","channels","reservation-metrics","turn-pulse","cleaning","kpi-housekeeping","priorities","arrivals","inhouse","departures"],
    hidden:["priorities","arrivals","inhouse","departures"],
    sizes:{occupancy:"2x2",channels:"2x1","reservation-metrics":"2x1","turn-pulse":"2x1"},
  },
  housekeeping:{
    label:"Housekeeping",
    description:"Habitaciones, salidas y prioridades de operación.",
    order:["cleaning","kpi-housekeeping","departures","arrivals","priorities","turn-pulse","occupancy","kpi-occupancy","inhouse","kpi-reservations","kpi-production","channels","reservation-metrics"],
    hidden:["kpi-production","channels","reservation-metrics"],
