...
export async function saveReservation({draft,room,propertyId,userId,original}){
  const data=payload(draft,room,propertyId,userId),pending=draft.pendingDocuments||[],pid=requirePropertyId(propertyId);let saved
  if(draft.id){
