...
export default function SignupForm(){
  ...
  async function submit(e){
    ...
    if(data?.session){location.href="/dashboard";return}
    setMessage("Cuenta creada. Revisá tu email para confirmar el acceso y después ingresá al hotel.");setKind("success")
  }
  return <section className={ui.card}>
    <div className={ui.note}><small>CREAR HOTEL</small><h2>Tu recepción empieza acá.</h2><p>Creá la cuenta propietaria. El hotel queda aislado por propiedad desde el primer acceso y después podés invitar a tu equipo con sus roles.</p></div>
    ...
    <p className={ui.small}>Al crear la cuenta se genera una propiedad independiente con vos como propietario. No compartimos datos entre hoteles.</p>
  </section>
}
