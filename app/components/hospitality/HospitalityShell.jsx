...
export default function HospitalityShell({eyebrow="HABITACIÓN LLENA",title,copy,children,hotelName="Habitación Llena",compact=false,backHref=null}){
    ...
    <section className={ui.frame}>
      ...
      <section className={ui.surface}>
        ...
        <div className={ui.content}>
          {backHref&&<a href={backHref} className={ui.back} aria-label="Volver"><span aria-hidden="true">←</span><b>Volver</b></a>}
          <a href="/" className={ui.brand}><span>HL</span><div><b>{hotelName}</b><small>Hotel OS</small></div></a>
