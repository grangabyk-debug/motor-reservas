export const metadata={title:"Habitación Llena | Estamos trabajando",description:"Habitación Llena está preparando una nueva versión.",robots:{index:false,follow:false}}
...
export default function Home(){
  return <main style={page}>
    <section style={card}>
      ...
      <p style={text}>Estamos mejorando la plataforma para ofrecer una experiencia mucho mejor. El sitio público y los nuevos registros están temporalmente pausados.</p>
      <div style={line}/>
