...
import launch from"./marketing/landing-launch.module.css"
...
export default async function Home(){const{slug}=await context();if(slug)return <HotelSite slug={slug}/>;return <div className={`${refinements.scope} ${launch.scope}`}><MarketingHome/></div>}
