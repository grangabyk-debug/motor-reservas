...
const pmsNextBranches=new Set(["pms-rebuild-zero","staging","main"])
const greenfield=pmsNextBranches.has(branch)||process.env.PMS_NEXT_BUILD==="1"
...
if(greenfield){
  console.log(`PMS Next prebuild: canonical validation for ${branch||"local PMS_NEXT_BUILD"}`)
